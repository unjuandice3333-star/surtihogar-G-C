...
function AppProvider({ children }) {
    ...
    const refreshData = async ()=>{
        try {
            ...
            // Load Profile
            const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('*').eq('id', session.user.id).maybeSingle();
            const user = profile || {
                id: session.user.id,
                name: 'Admin',
                role: 'admin'
            ...
            const [busRes, catRes] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('businesses').select('*'),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('categories').select('*')
            ]);
            // Active Shift Check
            const { data: activeShiftBusId } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].rpc('get_active_shift', {
                p_user_id: user.id,
            ...
            // Load Transactions
            let trxQuery = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('transactions').select('*').order('date', {
                ascending: false
            });
            ...
            let shifts = [];
            if (user.role === 'admin') {
                const { data: shRes } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('shifts').select('*, businesses(name)').order('start_time', {
                    ascending: false
                });
                shifts = shRes || [];
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0jq72b7._.js.map